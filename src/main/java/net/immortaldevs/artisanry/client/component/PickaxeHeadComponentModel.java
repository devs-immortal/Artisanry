...
public class PickaxeHeadComponentModel extends LoadedModelComponentModel {
    public PickaxeHeadComponentModel(Component component) {
        super(component);
    }
    ...
    public void itemRender(ComponentData data,
                           ...
                           int light,
                           int overlay) {
        matrices.translate(0.125, 0.0625, 0.0);
